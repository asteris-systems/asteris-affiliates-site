...
meta_description: "14-day money-back guarantee on every paid Asteris tier. Refunds processed within 24 hours via Lemon Squeezy. Read the full terms."
schema_type: WebPage
noindex: false
...
- Asteris Founder (one-time payment)
...
**Pre-renewal email.** We will email you at least **7 days before any subscription renewal charge**, to the address on file. You can cancel from that email or via the [Lemon Squeezy customer portal](https://app.lemonsqueezy.com/my-orders) at any time before the charge.
...
This is industry standard for SaaS (Yoast, Kit, RankMath, FunnelKit all operate the same way) and keeps the per-seat economics workable for a small Sydney team.
...
- Founder change-of-mind requests after the 14-day window (see Section 10)
...
To cancel a subscription without a refund, use the [Lemon Squeezy customer portal](https://app.lemonsqueezy.com/my-orders) → Cancel.

To get your money back, request a refund per Section 4.

---

## 11. Founder specifics

Founder (one-time payment) follows the same 14-day money-back guarantee as every other paid tier.

After 14 days, the Founder payment is **non-refundable for change-of-mind reasons**. This is because:
...
**Your statutory rights survive.** This 14-day cut-off applies only to change-of-mind requests. If Asteris suffers a major failure under the Australian Consumer Law (or your local equivalent) at any point in the lifetime period, your statutory remedies remain — including a refund of the Founder purchase price if a major failure cannot be remedied within a reasonable time.

If you simply want to opt out of using Asteris after 14 days, you can stop using it — your Founder payment is not refundable for change-of-mind past that window.
...
(a) decline future orders from your accounts and payment methods;
(b) terminate any active licences (including Founder, with no refund of the slot); and
(c) exercise our legal rights to recover any costs we incur, where permitted by law.
...
If you disagree with our refund decision and we cannot resolve it directly, escalate to [founder@asteriscommerce.com](mailto:founder@asteriscommerce.com) (direct line to Nick). If we still cannot agree:

- **Australian customers:** you can lodge a complaint with your state or territory fair trading agency, or the ACCC ([accc.gov.au](https://www.accc.gov.au)).
- **EU/EEA customers:** you may access the European Commission's Online Dispute Resolution platform at [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr/). Our contact email for ODR purposes is support@asterisaffiliates.com.
...
Refund requests: [support@asterisaffiliates.com](mailto:support@asterisaffiliates.com) (subject: `REFUND`)

Refund disputes after our decision: [founder@asteriscommerce.com](mailto:founder@asteriscommerce.com) (direct line to Nick)

My Cosmic Message Pty Ltd t/as Asteris Commerce · ACN: 652 358 159 · ABN: 30 652 358 159
